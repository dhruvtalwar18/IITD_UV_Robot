...
(cl:in-package teraranger_array-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <RangeArray>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'RangeArray)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name teraranger_array-msg:<RangeArray> is deprecated: use teraranger_array-msg:RangeArray instead.")))

(cl:ensure-generic-function 'header-val :lambda-list '(m))
(cl:defmethod header-val ((m <RangeArray>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader teraranger_array-msg:header-val is deprecated.  Use teraranger_array-msg:header instead.")
  (header m))

(cl:ensure-generic-function 'ranges-val :lambda-list '(m))
(cl:defmethod ranges-val ((m <RangeArray>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader teraranger_array-msg:ranges-val is deprecated.  Use teraranger_array-msg:ranges instead.")
  (ranges m))
