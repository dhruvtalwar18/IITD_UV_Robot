...
OPENCV_MODULES:=stitching aruco bgsegm bioinspired face objdetect img_hash saliency structured_light phase_unwrapping superres optflow text tracking dnn plot videostab video xfeatures2d shape ml ximgproc calib3d features2d highgui videoio imgcodecs flann xphoto photo imgproc core
...
ifeq ($(OPENCV_LIB_TYPE),SHARED)
    OPENCV_LIBS:=stitching aruco bgsegm bioinspired face objdetect img_hash saliency structured_light phase_unwrapping superres optflow text tracking dnn plot videostab video xfeatures2d shape ml ximgproc calib3d features2d highgui videoio imgcodecs flann xphoto photo imgproc core
    OPENCV_LIB_TYPE:=SHARED
else
