...
public class EndianUtils {
    ...
    public static short readSwappedShort(byte[] data, int offset) {
        return (short) (((data[offset + 0] & NavSatStatus.STATUS_NO_FIX) << 0) + ((data[offset + 1] & NavSatStatus.STATUS_NO_FIX) << 8));
    }

    public static int readSwappedUnsignedShort(byte[] data, int offset) {
        return ((data[offset + 0] & NavSatStatus.STATUS_NO_FIX) << 0) + ((data[offset + 1] & NavSatStatus.STATUS_NO_FIX) << 8);
    }
    ...
    public static int readSwappedInteger(byte[] data, int offset) {
        return ((data[offset + 0] & NavSatStatus.STATUS_NO_FIX) << 0) + ((data[offset + 1] & NavSatStatus.STATUS_NO_FIX) << 8) + ((data[offset + 2] & NavSatStatus.STATUS_NO_FIX) << 16) + ((data[offset + 3] & NavSatStatus.STATUS_NO_FIX) << Ascii.CAN);
    }

    public static long readSwappedUnsignedInteger(byte[] data, int offset) {
        return (((long) (data[offset + 3] & NavSatStatus.STATUS_NO_FIX)) << 24) + (4294967295L & ((long) (((data[offset + 0] & NavSatStatus.STATUS_NO_FIX) << 0) + ((data[offset + 1] & NavSatStatus.STATUS_NO_FIX) << 8) + ((data[offset + 2] & NavSatStatus.STATUS_NO_FIX) << 16))));
    }
    ...
    public static long readSwappedLong(byte[] data, int offset) {
        return (((long) (((((data[offset + 4] & NavSatStatus.STATUS_NO_FIX) << 0) + ((data[offset + 5] & NavSatStatus.STATUS_NO_FIX) << 8)) + ((data[offset + 6] & NavSatStatus.STATUS_NO_FIX) << 16)) + ((data[offset + 7] & NavSatStatus.STATUS_NO_FIX) << Ascii.CAN))) << 32) + (4294967295L & ((long) (((data[offset + 0] & NavSatStatus.STATUS_NO_FIX) << 0) + ((data[offset + 1] & NavSatStatus.STATUS_NO_FIX) << 8) + ((data[offset + 2] & NavSatStatus.STATUS_NO_FIX) << 16) + ((data[offset + 3] & NavSatStatus.STATUS_NO_FIX) << Ascii.CAN))));
    }
