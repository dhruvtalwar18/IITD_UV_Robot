...
public class Base64 implements BinaryEncoder, BinaryDecoder {
    ...
    static {
        ...
        int j2 = 0;
        while (i6 <= 51) {
            lookUpBase64Alphabet[i6] = (byte) (j2 + 97);
            i6++;
            j2++;
        }
        int i7 = 52;
        while (i7 <= 61) {
            lookUpBase64Alphabet[i7] = (byte) (j + 48);
            i7++;
            j++;
        }
    ...
    public static byte[] encodeBase64(byte[] binaryData, boolean isChunked) {
        ...
        int lengthDataBits3 = bArr.length * 8;
        ...
        while (i < numberTriplets3) {
            ...
            byte l = (byte) (b2 & Ascii.SI);
            byte k = (byte) (b1 & 3);
            byte val1 = (byte) ((b1 & UnsignedBytes.MAX_POWER_OF_TWO) == 0 ? b1 >> 2 : (b1 >> 2) ^ 192);
            ...
            if (!isChunked || encodedIndex2 != chunksSoFar) {
                ...
                chunksSoFar2++;
                chunksSoFar = ((chunksSoFar2 + 1) * 76) + (CHUNK_SEPARATOR.length * chunksSoFar2);
        ...
        int chunksSoFar3 = chunksSoFar2;
        int dataIndex2 = i * 3;
        if (fewerThan24bits == 8) {
            byte b12 = bArr[dataIndex2];
            byte k2 = (byte) (b12 & 3);
            encodedData[encodedIndex] = lookUpBase64Alphabet[(byte) ((b12 & UnsignedBytes.MAX_POWER_OF_TWO) == 0 ? b12 >> 2 : (b12 >> 2) ^ 192)];
            ...
            byte l2 = (byte) (b22 & Ascii.SI);
            byte k3 = (byte) (b13 & 3);
            byte val12 = (byte) ((b13 & UnsignedBytes.MAX_POWER_OF_TWO) == 0 ? b13 >> 2 : (b13 >> 2) ^ 192);
            byte val22 = (byte) ((b22 & UnsignedBytes.MAX_POWER_OF_TWO) == 0 ? b22 >> 4 : (b22 >> 4) ^ 240);
        ...
        if (isChunked && chunksSoFar3 < nbrChunks) {
    ...
    public static byte[] decodeBase64(byte[] base64Data) {
        ...
        for (int i = 0; i < numberQuadruple; i++) {
            ...
            if (marker0 != 61 && marker1 != 61) {
                ...
                decodedData[encodedIndex + 1] = (byte) (((b2 & Ascii.SI) << 4) | ((b3 >> 2) & 15));
                ...
                decodedData[encodedIndex] = (byte) ((b1 << 2) | (b2 >> 4));
                decodedData[encodedIndex + 1] = (byte) (((b2 & Ascii.SI) << 4) | ((b32 >> 2) & 15));
            }
            encodedIndex += 3;
        }
        return decodedData;
