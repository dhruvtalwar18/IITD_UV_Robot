...
public class URIUtil {
    ...
    public static String getPath(String uri) {
        ...
        if (from < 0) {
            return at >= 0 ? CookieSpec.PATH_DELIM : uri;
        }
    ...
    public static String encodePathQuery(String unescaped, String charset) throws URIException {
        ...
        stringBuffer.append(encode(unescaped.substring(0, at), URI.allowed_abs_path, charset));
        stringBuffer.append('?');
        stringBuffer.append(encode(unescaped.substring(at + 1), URI.allowed_query, charset));
