...
public class URI implements Cloneable, Comparable, Serializable {
    ...
    protected static final char[] rootPath = {IOUtils.DIR_SEPARATOR_UNIX};
    ...
    public URI(java.lang.String r8, java.lang.String r9, java.lang.String r10, int r11, java.lang.String r12, java.lang.String r13, java.lang.String r14) throws org.apache.commons.httpclient.URIException {
        ...
        L_0x0045:
            ...
            r5 = r13
            r6 = r14
            r1.<init>((java.lang.String) r2, (java.lang.String) r3, (java.lang.String) r4, (java.lang.String) r5, (java.lang.String) r6)
            return
        */
    ...
    public int indexFirstOf(String s, String delims2, int offset) {
        ...
        for (char indexOf : delim) {
            int at = s.indexOf(indexOf, offset);
            if (at >= 0 && at < min) {
                min = at;
            }
        }
    ...
    public void setRawPath(char[] escapedPath) throws URIException {
        ...
        if (this._is_net_path || this._is_abs_path) {
            ...
            int at = indexFirstOf(escapedPath2, (char) IOUtils.DIR_SEPARATOR_UNIX);
            if (at == 0) {
        ...
        } else if (this._is_opaque_part == 0) {
            throw new URIException(1, "incorrect path");
    ...
    public char[] resolvePath(char[] basePath, char[] relPath) throws URIException {
        ...
        if (at != -1) {
            char[] basePath2 = base.substring(0, at + 1).toCharArray();
        }
    ...
    public char[] removeFragmentIdentifier(char[] component) {
        ...
        if (lastIndex != -1) {
            return new String(component).substring(0, lastIndex).toCharArray();
        }
        return component;
    }
    ...
    public char[] normalize(char[] path2) throws URIException {
        ...
        while (true) {
            int indexOf = normalized2.indexOf("/./");
            index = indexOf;
            if (indexOf == -1) {
                break;
            }
            StringBuffer stringBuffer = new StringBuffer();
            stringBuffer.append(normalized2.substring(0, index));
            stringBuffer.append(normalized2.substring(index + 2));
            normalized2 = stringBuffer.toString();
        }
        if (normalized2.endsWith("/.")) {
            normalized2 = normalized2.substring(0, normalized2.length() - 1);
        }
        int i = index;
        int startIndex = 0;
        while (true) {
            int indexOf2 = normalized2.indexOf("/../", startIndex);
            int index2 = indexOf2;
            if (indexOf2 == -1) {
                break;
            }
            int slashIndex2 = normalized2.lastIndexOf(47, index2 - 1);
            if (slashIndex2 >= 0) {
                StringBuffer stringBuffer2 = new StringBuffer();
                stringBuffer2.append(normalized2.substring(0, slashIndex2));
                stringBuffer2.append(normalized2.substring(index2 + 3));
                normalized2 = stringBuffer2.toString();
            } else {
                startIndex = index2 + 3;
            }
        }
        if (normalized2.endsWith("/..") && (slashIndex = normalized2.lastIndexOf(47, normalized2.length() - 4)) >= 0) {
            normalized2 = normalized2.substring(0, slashIndex + 1);
        }
        while (true) {
            int indexOf3 = normalized2.indexOf("/../");
            int index3 = indexOf3;
            if (indexOf3 != -1 && normalized2.lastIndexOf(47, index3 - 1) < 0) {
                normalized2 = normalized2.substring(index3 + 3);
            }
        }
        if (normalized2.endsWith("/..") && normalized2.lastIndexOf(47, normalized2.length() - 4) < 0) {
            normalized2 = CookieSpec.PATH_DELIM;
        }
        return normalized2.toCharArray();
    }
    ...
    public static class DefaultCharsetChanged extends RuntimeException {
        ...
        public DefaultCharsetChanged(int reasonCode2, String reason2) {
            super(reason2);
            this.reason = reason2;
