    ...
    public void setRawUserinfo(char[] escapedUser, char[] escapedPassword) throws URIException {
        ...
        if (escapedUser == null || escapedUser.length == 0) {
            ...
            if (this._port == -1) {
                ...
                stringBuffer3.append(this._port);
                hostport = stringBuffer3.toString();
            }
            StringBuffer stringBuffer4 = new StringBuffer();
            stringBuffer4.append(userinfo);
            stringBuffer4.append("@");
            stringBuffer4.append(hostport);
            String authority = stringBuffer4.toString();
