...
public final class ChannelBuffers {
    ...
    public static int hashCode(ChannelBuffer buffer) {
        ...
        int arrayIndex2 = buffer.readerIndex();
        if (buffer.order() == BIG_ENDIAN) {
            ...
            int arrayIndex3 = arrayIndex2;
            int hashCode2 = 1;
            for (int i2 = intCount; i2 > 0; i2--) {
                hashCode2 = (hashCode * 31) + swapInt(buffer.getInt(arrayIndex));
                arrayIndex3 = arrayIndex + 4;
            }
        }
        int i3 = byteCount;
        while (i3 > 0) {
    ...
    public static boolean equals(ChannelBuffer bufferA, ChannelBuffer bufferB) {
        ...
        int aIndex2 = bufferA.readerIndex();
        int bIndex2 = bufferB.readerIndex();
    ...
    static String decodeString(ByteBuffer src, Charset charset) {
        ...
        CharBuffer dst = CharBuffer.allocate((int) (remaining * maxCharsPerByte));
        try {
