    ...
    public String rrToString() {
        ...
        if (this.other == null) {
            ...
            if (this.error != 18) {
                ...
                sb.append(new Date(1000 * ((((long) (this.other[0] & NavSatStatus.STATUS_NO_FIX)) << 40) + (((long) (this.other[1] & NavSatStatus.STATUS_NO_FIX)) << 32) + ((long) ((this.other[2] & NavSatStatus.STATUS_NO_FIX) << Ascii.CAN)) + ((long) ((this.other[3] & NavSatStatus.STATUS_NO_FIX) << 16)) + ((long) ((this.other[4] & NavSatStatus.STATUS_NO_FIX) << 8)) + ((long) (this.other[5] & NavSatStatus.STATUS_NO_FIX)))));
                sb.append(">");
            }
        }
        if (Options.check("multiline")) {
