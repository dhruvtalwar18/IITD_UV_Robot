...
public abstract class Record implements Cloneable, Comparable, Serializable {
    ...
    public static Record fromString(Name name2, int type2, int dclass2, long ttl2, Tokenizer st, Name origin) throws IOException {
        ...
        if (name2.isAbsolute()) {
            ...
            if (length == data2.length) {
                return newRecord(name2, type2, dclass2, ttl2, length, new DNSInput(data2));
            }
    ...
    public int hashCode() {
        ...
        int code = 0;
        for (byte b : array) {
            code += (code << 3) + (b & NavSatStatus.STATUS_NO_FIX);
        }
        return code;
    }
    ...
    public int compareTo(java.lang.Object r8) {
        /*
            ...
            return r1
        L_0x0007:
            org.xbill.DNS.Name r2 = r7.name
            org.xbill.DNS.Name r3 = r0.name
        ...
        L_0x001a:
            ...
            return r2
        L_0x0022:
            byte[] r3 = r7.rdataToWireCanonical()
            byte[] r4 = r0.rdataToWireCanonical()
        L_0x002b:
            int r5 = r3.length
