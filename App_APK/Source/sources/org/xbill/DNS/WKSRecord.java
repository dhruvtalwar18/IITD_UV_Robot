...
public class WKSRecord extends Record {
    ...
    public static class Service {
        ...
        static {
            ...
            services.add(5, "rje");
            services.add(7, "echo");
            services.add(9, Cookie2.DISCARD);
            ...
            services.add(53, Cookie2.DOMAIN);
    ...
    public WKSRecord(Name name, int dclass, long ttl, InetAddress address2, int protocol2, int[] services2) {
        ...
        if (Address.familyOf(address2) == 1) {
            ...
            this.services = new int[services2.length];
            System.arraycopy(services2, 0, this.services, 0, services2.length);
