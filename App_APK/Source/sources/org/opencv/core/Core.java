...
public class Core {
    ...
    public static class MinMaxLocResult {
        ...
        public double maxVal = opencv_stitching.Stitcher.ORIG_RESOL;
        public Point minLoc = new Point();
        public double minVal = opencv_stitching.Stitcher.ORIG_RESOL;
    }
    ...
    public static void divide(Mat src1, Scalar src2, Mat dst, double scale, int dtype) {
        Scalar scalar = src2;
        divide_3(src1.nativeObj, scalar.val[0], scalar.val[1], scalar.val[2], scalar.val[3], dst.nativeObj, scale, dtype);
    }

    public static void divide(Mat src1, Scalar src2, Mat dst, double scale) {
        Scalar scalar = src2;
        divide_4(src1.nativeObj, scalar.val[0], scalar.val[1], scalar.val[2], scalar.val[3], dst.nativeObj, scale);
    }
    ...
    public static void inRange(Mat src, Scalar lowerb, Scalar upperb, Mat dst) {
        ...
        inRange_0(src.nativeObj, scalar.val[0], scalar.val[1], scalar.val[2], scalar.val[3], scalar2.val[0], scalar2.val[1], scalar2.val[2], scalar2.val[3], dst.nativeObj);
    }
