...
public interface InviteRequest extends Message {
    ...
    public static final String _TYPE = "rocon_app_manager_msgs/InviteRequest";

    String getApplicationNamespace();

    boolean getCancel();

    String getRemoteTargetName();

    void setApplicationNamespace(String str);

    void setCancel(boolean z);

    void setRemoteTargetName(String str);
}
