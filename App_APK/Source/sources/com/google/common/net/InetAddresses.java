...
public final class InetAddresses {
    ...
    private static String convertDottedQuadToHex(String ipString) {
        ...
        String penultimate = Integer.toHexString(((quad[0] & NavSatStatus.STATUS_NO_FIX) << 8) | (quad[1] & NavSatStatus.STATUS_NO_FIX));
        String ultimate = Integer.toHexString(((quad[2] & NavSatStatus.STATUS_NO_FIX) << 8) | (quad[3] & NavSatStatus.STATUS_NO_FIX));
