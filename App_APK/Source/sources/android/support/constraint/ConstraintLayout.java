...
public class ConstraintLayout extends ViewGroup {
    ...
    public void setDesignInformation(int type, Object value1, Object value2) {
        if (type == 0 && (value1 instanceof String) && (value2 instanceof Integer)) {
            ...
            int index = name.indexOf(CookieSpec.PATH_DELIM);
            if (index != -1) {
                        ...
                        if (layoutParams2.circleConstraint != i) {
                            ...
                            if (layoutParams.baselineToBaseline != -1) {
                                ...
                                if (!(target10 == null || view6 == null || !(view6.getLayoutParams() instanceof LayoutParams))) {
                                    ...
                                    baseline.connect(target10.getAnchor(ConstraintAnchor.Type.BASELINE), 0, -1, ConstraintAnchor.Strength.STRONG, 0, true);
